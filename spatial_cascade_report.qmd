...
display$`Total birds` <- format(
  round(display$`Total birds` / 1000, 1), nsmall = 1, big.mark = ",")
display$`Median total birds lost` <- format(
  round(display$`Median total birds lost` / 1000, 1), nsmall = 1, big.mark = ",")
display$`Middle half of results` <- paste0(
  thousand_birds(display$`Loss p25`), " to ",
  thousand_birds(display$`Loss p75`))
...
names(display)[names(display) == "Total birds"] <- "Total birds (thousands)"
names(display)[names(display) == "Median total birds lost"] <-
  "Median birds lost (thousands)"
names(display)[names(display) == "Middle half of results"] <-
  "Middle half (thousand birds)"
