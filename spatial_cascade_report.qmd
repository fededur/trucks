...
#| tbl-cap: "Culling reduces bird losses nationally and across production types"
#| results: asis
...
## Culling reduces losses across production types

![Culling reduces bird losses across `r paste(production_types, collapse = " and ")`.](assets/spatial_cascade_loss_by_production_type.svg){#fig-loss-by-type fig-alt="Birds lost by production type with no culling and with culling"}
...
![Culling reduces repeated farm exposure, while the North Island remains more exposed.](assets/spatial_cascade_farm_risk_map.svg){#fig-farm-risk fig-alt="New Zealand farm bird-loss exposure without culling and with culling"}
