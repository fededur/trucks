...
The percentage outside brackets is the expected share lost. The bracketed
25th–75th percentile range is the middle half of complete scenario outcomes.
It shows run-to-run variation while keeping all model assumptions fixed.
