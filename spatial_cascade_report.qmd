...
**`r thousand_birds(cull$mean_baseline_total_loss)` thousand birds**.
With culling, that falls to about
**`r thousand_birds(cull$mean_cull_total_loss)` thousand birds**.
That is an expected reduction of
**`r thousand_birds(cull$mean_net_loss_avoided)` thousand birds**,
...
Bird counts are shown in thousand birds. The expected share is the expected national loss divided by the birds
...
**`r thousand_birds(cull$mean_direct_cull_loss)` thousand birds**
