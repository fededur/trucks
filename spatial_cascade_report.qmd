...
- North Island farms are more exposed: their average chance of being lost is
  **`r round(north$mean_lost_probability, 1)`%**, compared with
  **`r round(south$mean_lost_probability, 1)`%** in the South Island. More farms
  are in the North Island, making a random start there more likely, while
  spread between islands is blocked.
