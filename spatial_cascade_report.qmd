...
- Without culling, bird losses are widespread across most modelled outbreaks.

- Early culling reduces the expected national loss by about
...
- The final loss varies between outbreaks, even though the same farms and
  model settings are used each time.

- The production-type results show where the national loss falls, while the
  map identifies farms and areas that are repeatedly exposed.

- These results support planning and comparison. They are not a forecast of a
  future outbreak.
