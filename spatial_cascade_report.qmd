...
![Total production-capacity loss across matched scenarios, split into No culling and Culling panels on the same scale. Each box shows the middle half of results, its centre line is the median, and the whiskers and points show the wider range. Culling loss includes production removed directly through culling as well as farms otherwise reaching the lost state.](assets/spatial_cascade_cull_comparison.svg){#fig-cull-comparison fig-alt="Faceted comparison of total production capacity loss in matched scenarios with no culling and with culling"}
